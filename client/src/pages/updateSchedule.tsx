...
export const UpdateSchedule = () => {
    ...
    const searchCheque = () => {
        ...
        axios.get<IScheduleData>(process.env.REACT_APP_API_URL + '/updateCheque' + `?sno=${searchSno}&sno2=${searchChqno}`)
            .then((res) => {
                console.log({ res });
    ...
    return (
        <>
            <br /> <Typography.Title level={3}>Cancel Cheque </Typography.Title>
